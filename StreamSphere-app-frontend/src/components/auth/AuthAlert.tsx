...
const styles = {
  error: {
    container:
      "border-[rgba(215,55,45,0.35)] bg-[rgba(65,15,15,0.3)]",
  ...
  success: {
    container:
      "border-[rgba(34,197,94,0.35)] bg-[rgba(22,101,52,0.2)]",
    icon: "text-green-400",
...
export default function AuthAlert({ type, message, onDismiss, autoDismissMs }: AuthAlertProps) {
